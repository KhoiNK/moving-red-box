 ...
 */
if (true) {
  var ReactIs = __webpack_require__("./node_modules/react-is/index.js"); // By explicitly using `prop-types` you are opting into new development behavior.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */if(true){(function(){'use strict';var React=__webpack_require__("./node_modules/react/index.js");var _assign=__webpack_require__("./node_modules/object-assign/index.js");var Scheduler=__webpack_require__("./node_modules/scheduler/index.js");var tracing=__webpack_require__("./node_modules/scheduler/tracing.js");var ReactSharedInternals=React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;// by calls to these methods by a Babel plugin.
//
...
console.info('%cDownload the React DevTools '+'for a better development experience: '+'https://reactjs.org/link/react-devtools'+(protocol==='file:'?'\nYou might need to use a local HTTP server (instead of file://): '+'https://reactjs.org/link/react-devtools-faq':''),'font-weight:bold');}}}}__webpack_unused_export__=Internals;__webpack_unused_export__=createPortal$1;__webpack_unused_export__=findDOMNode;__webpack_unused_export__=flushSync;__webpack_unused_export__=hydrate;exports.render=render;__webpack_unused_export__=unmountComponentAtNode;__webpack_unused_export__=batchedUpdates$1;__webpack_unused_export__=unstable_createPortal;__webpack_unused_export__=renderSubtreeIntoContainer;__webpack_unused_export__=ReactVersion;})();}
...
if (true) {
  (function () {
    ...
    var _assign = __webpack_require__("./node_modules/object-assign/index.js"); // TODO: this is special because it gets imported during build.
...
function ye(e) {
  ...
  return (0,react.useEffect)(function () {
    ...
    value: l
  },  true ? react.Children.only(e.children) : 0));
}
...
function Ne(e, n, r, o) {
  ...
  if (b(e)) {
    ...
    var u = e(n);
    return  true && (0,react_is.isElement)(u) && console.warn(_(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), Ne(u, n, r, o);
  }
  ...
  return e instanceof ve ? r ? (e.inject(r, o), e.getName(o)) : e : S(e) ? function e(t, n) {
    ...
    for (var i in t) t.hasOwnProperty(i) && !_e(t[i]) && (S(t[i]) ? s.push.apply(s, e(t[i], i)) : b(t[i]) ? s.push(be(i) + ":", t[i], ";") : s.push(be(i) + ": " + (r = i, null == (o = t[i]) || "boolean" == typeof o || "" === o ? "" : "number" != typeof o || 0 === o || r in unitless_browser_esm ? String(o).trim() : o + "px") + ";"));
...
var Ce = /invalid hook call/i,
  ...
  if (true) {
    ...
    try {
      (0,react.useRef)(), Ie.has(n) || (console.warn(n), Ie.add(n));
    } catch (e) {
  ...
  var C,
    ...
    return function (e, t, n, r) {
      ...
      var f = function (e, t, n) {
        ...
        return  true && (0,react.useDebugValue)(i),  true && !t && r && r(i), i;
      ...
      for (var I in A) "$" !== I[0] && "as" !== I && ("forwardedAs" === I ? C.as = A[I] : (d ? d(I, is_prop_valid_browser_esm) : !N || is_prop_valid_browser_esm(I)) && (C[I] = A[I]));
...
function $e(e) {
  ...
  function l(e) {
    ...
    return  true && r.Children.count(e.children) && console.warn("The global style component " + a + " was given child JSX. createGlobalStyle does not render children."),  true && i.some(function (e) {
...
var Ue = function () {
  ...
  var t = r.forwardRef(function (t, n) {
    var o = s(ze),
        i = e.defaultProps,
        a = Oe(t, o, i);
    return  true && void 0 === a && console.warn('[withTheme] You are not using a ThemeProvider nor passing a theme prop or a theme in defaultProps in component class "' + _(e) + '"'), r.createElement(e, v({}, t, {
      theme: a,
      ref: n
    }));
  });
...
// CONCATENATED MODULE: ./src/components/box.js
;
...
var styles = __webpack_require__("./node_modules/css-loader/dist/cjs.js!./src/styles.css");
...
function App() {
  var _useState = (0,react.useState)({
    ...
    left: 0
      ...
      coor = _useState2[0],
      setCoor = _useState2[1];

  var _useState3 = (0,react.useState)(500),
  ...
  var onChangeDuration = function onChangeDuration(e) {
    try {
  ...
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(InputWrapper, {
    height: INPUT_WRAPPER_HEIGHT
  }, /*#__PURE__*/react.createElement("label", null, "Animation duration (ms):"), /*#__PURE__*/react.createElement(Input, {
    isError: isError,
    onChange: onChangeDuration,
    type: "number"
  }), ' ', /*#__PURE__*/react.createElement(ErrorLabel, {
    showError: isError
  }, "Only positive number is accepted")), /*#__PURE__*/react.createElement("div", {
    className: "App",
    onClick: onClick
...
var InputWrapper = styled_components_browser_esm.div.withConfig({
  displayName: "App__InputWrapper",
  componentId: "lu3nmu-0"
})(["height:", ";"], function (props) {
  return props.height;
});
var Input = styled_components_browser_esm.input.withConfig({
  displayName: "App__Input",
  componentId: "lu3nmu-1"
})(["", ""], function (props) {
  return props.isError ? "border-color: red; color: red" : '';
});
var ErrorLabel = styled_components_browser_esm.div.withConfig({
  displayName: "App__ErrorLabel",
  componentId: "lu3nmu-2"
})(["color:red;display:", ""], function (props) {
  return props.showError ? 'inline-block' : 'none';
});
...
react_dom.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(App, null)), rootElement);
})();
